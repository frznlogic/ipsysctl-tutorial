...
<style-specification id="docbook"
   use="ca cs da de el en es et fi fr hu id it ja ko nl no pl pt ptbr ro ru sk sl sv zhcn param dblib">

<style-specification-body>

;; $Id: docbook.dsl,v 1.1 2002/11/21 20:52:34 blueflux Exp $
;;
